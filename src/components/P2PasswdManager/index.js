    ...
    <>
              ...
              <Card>
                <Card.Body>
                  ...
                  <Card.Title><strong className='text-danger'>Password Manager Application</strong></Card.Title>
                  <Card.Text>
                    React Application
                    <br/>
                    <small>Technologies & Tools : MongoDB, NodeJS, ExpressJS, ReactJS</small>
                  </Card.Text>
                  <Button variant="dark" className="text-light" onClick={() => setModalShow(true)}>
...
export default P2PasswdManager;